...
(async () => {
  ...
  // --- 2. Retrieve Elements and Arguments ---
  const timeReminder = document.getElementById("time-reminder")!;
  const reasonText = document.getElementById("reason-text")!;

  // Arguments are stored globally by the background script just before this runs
  ...
  // --- 3. Reminder Logic (Simplified Logic from previous TS) ---
